...
PRIVACY_NOTICE_JA = "RGB映像は使用していません / UDP送信は設定で管理されています"
...
TRUNCATED_JA = "間引きあり"
CALIBRATING_JA = "静止状態を学習中（残り{seconds:.1f}秒）"
BACKGROUND_SUBTRACTED_JA = "背景減算後 {count}件"
