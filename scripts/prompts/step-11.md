...
2. docs/implementation-plan.md    … 実装順序とテスト項目。**§3 の「Step 11」の節が今回の仕様**
...
docs/implementation-plan.md §3 の **Step 11** の節に書かれている内容を、そのとおりに実装する。

作成対象ファイル（目安。正確な一覧は implementation-plan.md の該当節を見ること）:
ui/detail_window.py, ui/panels/__init__.py, panels/event_scatter_panel.py, panels/motion_panel.py, panels/region_panel.py, panels/feature_table_panel.py, panels/history_panel.py
